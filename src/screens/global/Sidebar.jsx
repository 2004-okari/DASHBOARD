  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem icon={<IoPeopleOutline />} component={<Link to="/manage" />}>
          Manage Team
        </MenuItem>
        ...
        <MenuItem icon={<IoPersonOutline />} component={<Link to="/profile" />}>
          Profile Form
        </MenuItem>
        <MenuItem
        ...
        <MenuItem icon={<IoListOutline />} component={<Link to="/task" />}>
          Task Bar
        </MenuItem>
        <MenuItem icon={<IoCreateOutline />} component={<Link to="/text" />}>
          Text Editor
        </MenuItem>
        <MenuItem icon={<IoHelpCircleOutline />} component={<Link to="/faq" />}>
          FAQ page
        </MenuItem>
        <p className="nav-item">Charts</p>
        <MenuItem icon={<IoPieChartOutline />} component={<Link to="/pie" />}>
          Pie Chart
        </MenuItem>
        <MenuItem icon={<IoBarChartOutline />} component={<Link to="/bar" />}>
          Bar Chart
        </MenuItem>
        <MenuItem
